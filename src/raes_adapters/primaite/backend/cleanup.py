"""Verified cleanup execution for the in-process PrimAITE driver."""
...
def _evidence_ref(obligation_id: str, disposition: str) -> str:
    ...
    return f"evidence.primaite.cleanup.{obligation_id}.{disposition}"
...
def _destroy(
    ...
    """Close the source, remove the workspace, and verify the clean state."""
...
__all__ = ["execute_primaite_cleanup"]
